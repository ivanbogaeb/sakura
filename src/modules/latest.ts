    ...
    try {
        ...
        if (data){
            ...
            try {
                ...
                await windowMessenger(isElectron, {type: 'message', payload: {type: 1, text: "Unable to communicate with updating service", loader: {active: false, data: 0, total: 0, percentage: 0}}});
                await timer(2000);
